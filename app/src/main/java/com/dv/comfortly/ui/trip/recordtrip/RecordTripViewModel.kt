...
class RecordTripViewModel
    ...
    constructor(
        ...
        private var gyroscopeData =
            GyroscopeGraphData(emptyList(), emptyList(), emptyList(), emptyList(), emptyList(), emptyList())
        private var linearAccelerationData = GraphData(emptyList(), emptyList(), emptyList())
        private var rotationVectorData =
            RotationVectorGraphData(
                emptyList(),
                emptyList(),
                emptyList(),
                emptyList(),
                    ...
                    if (tripId == -1L) {
                        ...
                        if (RecordTripActivity.includedCharts.contains(ChartTab.GRAVITY)) {
                            ...
                            gravityData =
                                gravityData.copy(
                                    xAxis =
                                        gravityData.xAxis.appendWithLimitSize(
                                            Entry(
                                                currentIndex,
                                    ...
                                    yAxis =
                                        gravityData.yAxis.appendWithLimitSize(
                                            Entry(
                                                currentIndex,
                                    ...
                                    zAxis =
                                        gravityData.zAxis.appendWithLimitSize(
                                            Entry(
                                                currentIndex,
                        ...
                        if (RecordTripActivity.includedCharts.contains(ChartTab.GYROSCOPE)) {
                            ...
                            gyroscopeData =
                                gyroscopeData.copy(
                                    ...
                                    orientationX =
                                        gyroscopeData.orientationX.appendWithLimitSize(
                                            Entry(
                                                currentIndex,
                                    ...
                                    orientationY =
                                        gyroscopeData.orientationY.appendWithLimitSize(
                                            Entry(
                                                currentIndex,
                        ...
                        if (RecordTripActivity.includedCharts.contains(ChartTab.ROTATION_VECTOR)) {
                            ...
                            rotationVectorData =
                                rotationVectorData.copy(
                                    ...
                                    orientationX =
                                        rotationVectorData.orientationX.appendWithLimitSize(
                                            Entry(
                                                currentIndex,
                                    ...
                                    orientationY =
                                        rotationVectorData.orientationY.appendWithLimitSize(
                                            Entry(
                                                currentIndex,
