...
object TripEcgCalibrationSampleMapper {
    ...
    fun domainToDb(data: EcgDataSample): DbTripEcgCalibrationSample = DbTripEcgCalibrationSample(
        id = data.id,
        tripId = data.tripId,
    ...
    fun dbToDomain(data: DbTripEcgCalibrationSample): EcgDataSample = EcgDataSample(
        id = data.id,
        tripId = data.tripId,
        timestamp = data.timestamp,
        value = data.ecgValue
