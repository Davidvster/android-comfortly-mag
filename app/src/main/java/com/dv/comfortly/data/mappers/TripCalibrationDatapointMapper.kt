...
object TripCalibrationDatapointMapper {
    ...
    fun dbToDomain(data: DbTripCalibrationDatapoint): TripDatapoint = TripDatapoint(
        id = data.id,
        tripId = data.tripId,
    ...
    fun domainToDb(data: TripDatapoint): DbTripCalibrationDatapoint = DbTripCalibrationDatapoint(
        tripId = data.tripId,
        timestamp = data.timestamp,
        accelerometerData = DbSensorData(
        ...
        linearAccelerometerData = DbSensorData(
        ...
        rotationVectorData = DbRotationVectorSensorData(
