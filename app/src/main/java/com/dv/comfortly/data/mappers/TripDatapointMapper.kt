...
object TripDatapointMapper {

    fun dbToDomain(data: DbTripDatapoint): TripDatapoint = TripDatapoint(
        id = data.id,
        tripId = data.tripId,
    ...
    fun domainToDb(data: TripDatapoint): DbTripDatapoint = DbTripDatapoint(
        tripId = data.tripId,
        timestamp = data.timestamp,
